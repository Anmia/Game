...
public class Story {
    ...
    private void wiper() {
	for (int i = 0; i < optVal.length - 4; i++) {
            optVal[i] = -1;
            optName[i] = null;
        }
    }
        ...
        switch(storyStep) {
            ...
            case 4:
				...
				if(gameOver) {
					...
					toPrint = "It takes you a few moments to realize, but you "
						+ "have won. \"Well done,\" you hear Skeggulgt say and "
						+ "you turn to see him leaning against the first wagon, "
						+ "a grin on his face. The grin quickly disapears as you "
						+ "hear a rustle behind you";
				}
